@ECHO OFF
TITLE UrbanSafeLivabilityModel
...
CD UrbanSafeLivabilityModel

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./UrbanSafeLivabilityModel.rs
