...
public class DataCollection {
	...
	private int moveInFamilyNumber_now = 0;// 当年迁入家庭�?
	private int moveOutFamilyNumber_now = 0;// 当年迁出家庭�?
	private int deathFamilyNumber_now = 0;// 死亡家庭�?
	...
	private double[] streetSatisfaction = new double[Parameter.streetNumber];// 街道满意�?
	private double[] gridSatisfaction = new double[Parameter.gridNumber];// 网格满意�?

	/**
	 * 宜居度收�?
	 */
	private double futianLivability = 0;// 福田区宜居度
	private double[] streetLivability = new double[Parameter.streetNumber];// 街道宜居�?
	private double[] gridLivability = new double[Parameter.gridNumber];// 网格宜居�?
